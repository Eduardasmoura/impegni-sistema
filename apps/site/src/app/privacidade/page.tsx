...
export const metadata: Metadata = { title: "Política de privacidade — InovaFlow" };
    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-16">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Este documento está em elaboração e será publicado aqui antes do lançamento oficial, detalhando como os dados de empresas e clientes são tratados no InovaFlow, em conformidade com a LGPD. Qualquer dúvida pode ser esclarecida diretamente com o{" "}
