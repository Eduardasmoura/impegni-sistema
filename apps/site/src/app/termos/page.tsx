...
export const metadata: Metadata = { title: "Termos de uso — Impegni" };
    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-16">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Este documento está em elaboração e será publicado aqui antes do lançamento oficial. Enquanto isso, qualquer dúvida sobre o uso do Impegni pode ser esclarecida diretamente com o{" "}
