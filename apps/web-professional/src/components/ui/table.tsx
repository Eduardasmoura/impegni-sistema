...
// Tabela padrão shadcn/ui — não existia neste app ainda (as listas até
// aqui eram sempre grade de cards). Mesmo padrão visual dos outros
// componentes de ui/ (Dialog, Select etc.), só que faltava. Usada pela
// primeira vez na tela de Clientes (reformulação CRM).
