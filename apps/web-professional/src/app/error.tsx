...
// qualquer tela cai na página de erro padrão do Next (em branco/genérica).
// Cobre erros de render; erros de rede/RLS nas próprias telas já são
// tratados via isError do React Query, isso aqui é a última rede de
// segurança.
